...
use "rawdata/okbay_eduyears_snps_all_270_rsid_01.raw.dta",clear
forvalues k=2(1)22{
	if `k'<10{
		local k="0`k'"
		}
	cap:joinby n_eid using "rawdata/okbay_eduyears_snps_all_270_rsid_`k'.raw.dta",unmatched(both)
	cap:drop _m
	}
gen n=_n
compress
...
//270 SNPs
import delimited "rawdata/okbay_hill_all_270_rsid.txt",clear
rename v1 rsid
...
import delimited "rawdata/270_snpstats_updated.txt",clear
...
use "workingdata/okbay_eduyears_snps_all_270_clean.dta",clear
