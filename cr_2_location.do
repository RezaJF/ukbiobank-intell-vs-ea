...
use n_eid n_129_?_0 n_130_?_0 using "$path3/data.8434.dta",clear
...
use n_eid n_20074_?_0 n_20075_?_0 n_20118* using "/Volumes/data/derived/format/stata/data.4263.dta",clear
...
import delimited "rawdata/ONSPD_FEB_2017_UK/Data/ONSPD_FEB_2017_UK.csv", delimiter(comma) encoding(ISO-8859-1) clear
...
compress
save "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round100",replace

use "workingdata/east_north_rural_urban_imd",clear
gen easting_round=round(easting,1000)
gen northing_round=round(northing,1000)
compress
save "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round1000",replace

use "workingdata/east_north_rural_urban_imd",clear
gen easting_round=round(easting,10000)
gen northing_round=round(northing,10000)
compress
save "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round10000",replace

use "workingdata/east_north_rural_urban_imd",clear
gen easting_round=round(easting,100000)
gen northing_round=round(northing,100000)
compress
save "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round100000",replace
...
drop r imd
joinby easting_round northing_round using "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round100",unmatched(master)
preserve
keep if _m==1
...
drop _m-imd
joinby easting_round northing_round using "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round1000",unmatched(master)
...
drop _m-imd
joinby easting_round northing_round using "/Users/ecnmd/Desktop/temp/east_north_rural_urban_imd_round10000",unmatched(master)
